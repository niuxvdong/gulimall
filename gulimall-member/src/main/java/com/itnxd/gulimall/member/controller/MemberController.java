package com.itnxd.gulimall.member.controller;

import java.util.Arrays;
import java.util.Map;

import com.itnxd.gulimall.member.feign.CouponFeignService;
...
import com.itnxd.gulimall.member.service.MemberService;
...
public class MemberController {
    ...
    public R test(){
        ...
        R memberCoupons = couponFeignService.couponMember();
